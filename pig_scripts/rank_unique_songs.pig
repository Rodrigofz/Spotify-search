...
-- Ranking
rankings = LOAD 'hdfs://cm:9000/uhadoop2020/3grupo/test_v5/total/part-r-00000' USING PigStorage('\t') AS (key, ranking:double);
...
-- Save
STORE ordered INTO 'hdfs://cm:9000/uhadoop2020/3grupo/test_v5/rankings_chile';
